...
def handle_client(client_socket, address):
    ...
    try:
        ...
        while True:
            ...
            client_public_key_hex, ciphertext_hex = [part for part in data.split(':')]
            client_public_key = ec.Point(ec.secp256k1, 0, 0)
            client_public_key.hex_decode(client_public_key_hex)
            ciphertext = ec.Point(ec.secp256k1, 0, 0)
